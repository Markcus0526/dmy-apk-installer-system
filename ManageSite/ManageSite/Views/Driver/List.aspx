...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
                <form action="<%= ViewData["rootUri"] %>Driver/DeleteDrivers" method="post">
				    ...
				    <div class="portlet box light-grey">
					    <div class="portlet-title">
						    <div class="caption"><i class="icon-user"></i>驱动程序列表</div>
						    <div class="actions">
							    <a href="<%= ViewData["rootUri"] %>Driver/Add" class="btn blue"><i class="icon-plus"></i> 新增记录</a>
...
<% } %>
	        ...
	        $('#sample_1').dataTable({
	            "bServerSide": true,
	            "bProcessing": true,
	            "sAjaxSource": rootUri + "Driver/RetrieveDriverList", 
                "oLanguage": {
	            ...
	            "aoColumnDefs": [
				    ...
				    },
				    {
				        ...
				        fnRender: function (o, v) {   // o, v contains the object and value for the column
				            return '<a href="' + rootUri + 'Driver/Add/' + o.aData[4] + '">编辑</a>';
				        },
				        sClass: 'tableCell'    // Optional - class to be applied to this table cell
				    }
                ],
