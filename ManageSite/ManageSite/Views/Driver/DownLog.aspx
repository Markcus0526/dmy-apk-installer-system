...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
                <form action="<%= ViewData["rootUri"] %>Driver/DeleteDownLog" method="post">
				    ...
				    <div class="portlet box light-grey">
					    <div class="portlet-title">
						    <div class="caption"><i class="icon-user"></i>驱动下载历史列表</div>
						    <div class="actions">
						    ...
						    <table class="table table-striped table-bordered table-hover" id="sample_1">
							    <thead>
								    <tr>
									    ...
									    <th>用户名</th>
									    <th>驱动名称</th>
									    <th class="hidden-480">下载开始时间</th>
									    <th class="hidden-480">下载完成时间</th>
									    <th>结果</th>
								    </tr>
							    </thead>
							    <tbody>
...
<% } %>
	        ...
	        $('#sample_1').dataTable({
	            "bServerSide": true,
	            "bProcessing": true,
	            "sAjaxSource": rootUri + "Driver/RetrieveDownLogList", 
                "oLanguage": {
