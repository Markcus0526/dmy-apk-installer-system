...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
                <form action="<%= ViewData["rootUri"] %>Admin/DeleteAdmins" method="post">
				    ...
				    <div class="portlet box light-grey">
					    <div class="portlet-title">
						    ...
						    <div class="actions">
							    <a href="<%= ViewData["rootUri"] %>Admin/Add" class="btn blue"><i class="icon-plus"></i> 新增记录</a>
