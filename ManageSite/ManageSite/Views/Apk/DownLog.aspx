...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
                <form action="<%= ViewData["rootUri"] %>Apk/DeleteDownLog" method="post">
				    ...
				    <div class="portlet box light-grey">
					    <div class="portlet-title">
						    <div class="caption"><i class="icon-user"></i>下载APK历史列表</div>
						    <div class="actions">
...
<% } %>
	        ...
	        $('#sample_1').dataTable({
	            "bServerSide": true,
	            "bProcessing": true,
	            "sAjaxSource": rootUri + "Apk/RetrieveDownLogList", 
                "oLanguage": {
