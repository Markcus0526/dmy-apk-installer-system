...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
                <form action="<%= ViewData["rootUri"] %>Apk/DeletePackages" method="post">
				    ...
				    <div class="portlet box light-grey">
					    <div class="portlet-title">
						    <div class="caption"><i class="icon-user"></i>APK套餐列表</div>
						    <div class="actions">
							    <a href="<%= ViewData["rootUri"] %>Apk/AddPackage" class="btn blue"><i class="icon-plus"></i> 新增记录</a>
...
<% } %>
	        ...
	        $('#sample_1').dataTable({
	            "bServerSide": true,
	            "bProcessing": true,
	            "sAjaxSource": rootUri + "Apk/RetrievePackageList", 
                "oLanguage": {
