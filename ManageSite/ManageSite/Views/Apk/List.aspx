...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
                <form action="<%= ViewData["rootUri"] %>Apk/DeleteApks" method="post">
				    ...
				    <div class="portlet box light-grey">
					    <div class="portlet-title">
						    <div class="caption"><i class="icon-user"></i>安卓安装包列表</div>
						    <div class="actions">
							    <a href="<%= ViewData["rootUri"] %>Apk/Add" class="btn blue"><i class="icon-plus"></i> 新增记录</a>
...
<% } %>
	        ...
	        $('#sample_1').dataTable({
	            "bServerSide": true,
	            "bProcessing": true,
	            "sAjaxSource": rootUri + "Apk/RetrieveApkList", 
                "oLanguage": {
