var FormComponents = function () {
    ...
    var handleWysihtml5 = function () {
        ...
        if ($('.wysihtml5').size() > 0) {
            $('.wysihtml5').wysihtml5({
                "stylesheets": [rootUri + "Content/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
            });
        }
    }
    ...
    var handleSelect2 = function () {
        ...
        function format(state) {
            ...
            return "<img class='flag' src='" + rootUri + "Content/img/flags/" + state.id.toLowerCase() + ".png'/>&nbsp;&nbsp;" + state.text;
        }
