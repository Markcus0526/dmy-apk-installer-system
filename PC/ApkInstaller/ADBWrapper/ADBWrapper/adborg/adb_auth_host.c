...
static int write_public_keyfile(RSA *private_key, const char *private_key_path)
{
    ...
    ret = _snprintf(path, sizeof(path), "%s.pub", private_key_path);
...
static int get_user_keyfilepath(char *filename, size_t len)
{
    ...
    if (_snprintf(android_dir, sizeof(android_dir), format, home,
    ...
    return _snprintf(filename, len, format, android_dir, ADB_KEY_FILE);
}
